...
dataset_store_path = '../interaction_graph_datasets/NeurIPS2021_test'

rna_anndata = sc.read_h5ad("../original_datasets/NeurIPS2021_Multiome/neurips2021_multiome_scRNA.h5ad")
print('rna_anndata:',rna_anndata) #69249 cells, 13431 genes
atac_anndata = sc.read_h5ad("../original_datasets/NeurIPS2021_Multiome/neurips2021_multiome_scATAC.h5ad")
print('atac_anndata:',atac_anndata) #69249 cells, 116490 peaks
...
rna_var_df = rna_anndata.var.copy()[['chrom']]
...
rna_var_np = np.hstack((rna_var_rowindex.reshape(-1,1),rna_var_chrom_np_onehot))
...
sequences = []
max_len = 256
with open("../original_datasets/NeurIPS2021_Multiome/NeurIPS2021_peak_output.fa", 'r') as f:
    seq = ""
    for line in f:
        line = line.strip()
        if line.startswith(">"):
