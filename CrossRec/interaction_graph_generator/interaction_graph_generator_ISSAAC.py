...
selected_cell_type = ["R6 Ex-L5-PT","R12 Misc","R14 In-Hap1"] # Cell types for training should >=3.
...
rna_anndata = sc.read_h5ad("../original_datasets/ISSAAC-seq/ISSAAC_scRNA_format.h5ad")
print('rna_anndata:',rna_anndata) #10361 cells,20771 genes
atac_anndata = sc.read_h5ad("../original_datasets/ISSAAC-seq/ISSAAC_scATAC_format.h5ad")
...
sequences = []
max_len = 256 
with open("../original_datasets/ISSAAC-seq/ISSAAC_peak_output.fa", 'r') as f:
    seq = ""
    for line in f:
        line = line.strip()  
        if line.startswith(">"):
