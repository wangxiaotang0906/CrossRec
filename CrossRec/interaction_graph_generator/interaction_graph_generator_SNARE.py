...
dataset_store_path = '../interaction_graph_datasets/SNARE_test'

rna_anndata = sc.read_h5ad("../original_datasets/SNARE-seq/Chen-2019-RNA.h5ad")
print('rna_anndata:',rna_anndata) #9190 cells, 28930 genes
atac_anndata = sc.read_h5ad("../original_datasets/SNARE-seq/Chen-2019-ATAC.h5ad")
...
sequences = []
max_len = 256
with open("../original_datasets/SNARE-seq/SNARE_peak_output.fa", 'r') as f:
    seq = ""
    for line in f:
        line = line.strip()
        if line.startswith(">"):
